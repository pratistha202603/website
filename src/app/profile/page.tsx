...
export default function ProfilePage() {
  ...
  return (
    <main className="min-h-screen px-6 py-16 text-white mt-20 space-y-10">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        {!accommodation ? (
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-6">
            <p><span className="text-gray-400">College:</span> {accommodation.college}</p>
            <p><span className="text-gray-400">Gender:</span> {accommodation.gender}</p>
            <p><span className="text-gray-400">Days:</span> {accommodation.days}</p>
            <p><span className="text-gray-400">Amount:</span> ₹{accommodation.amount}</p>
            <p>
            ...
            <p>
              <span className="text-gray-400">is Verified:</span>{" "}
